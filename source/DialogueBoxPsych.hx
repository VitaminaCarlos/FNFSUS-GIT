...
class DialogueBoxPsych extends FlxSpriteGroup
{
	...
	public function new(dialogueList:DialogueFile, ?song:String = null)
	{
		...
		box = new FlxSprite(46, 456);
		box.frames = Paths.getSparrowAtlas('sus_speechSquares');
		box.scrollFactor.set();
		box.antialiasing = ClientPrefs.globalAntialiasing;
		box.animation.addByPrefix('normal', 'speech square normal', 24);
		box.animation.addByPrefix('normalOpen', 'speech square open', 24, false);
		box.animation.addByPrefix('angry', 'speech square normal', 24);
		box.animation.addByPrefix('angryOpen', 'speech square open', 24, false);
		box.animation.addByPrefix('center-normal', 'speech square normal', 24);
		box.animation.addByPrefix('center-normalOpen', 'speech square open', 24, false);
		box.animation.addByPrefix('center-angry', 'speech square normal', 24);
		box.animation.addByPrefix('center-angryOpen', 'speech square open', 24, false);
